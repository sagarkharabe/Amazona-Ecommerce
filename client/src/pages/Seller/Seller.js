...
const Seller = ({ auth, seller, products, getSellerProducts, cartItems, history, match }) => {
  useEffect(() => {
  ...
  return (
    <Layout>
      <div>
        <Typography.Text strong>Viewing results for store <span style={{ color: '#C35600' }}>"{seller?.storeName}"</span></Typography.Text>
